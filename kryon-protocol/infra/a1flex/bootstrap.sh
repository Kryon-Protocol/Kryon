...
if (( TOTAL_MB < 8000 )); then
  warn "Only ${TOTAL_MB}MB RAM — this looks like the micro shape, not A1.Flex 4/24."
  warn "The Postgres tuning below assumes ~24GB and will over-commit here."
